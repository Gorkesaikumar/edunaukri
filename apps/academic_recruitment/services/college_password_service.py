"""Secure password change for institution settings portal."""
...
class CollegePasswordService(BaseService):
    def __init__(self):
        self.audit = AuthAuditService()
        self.sessions = SessionManagementService()
        self.settings = CollegeAccountSettingsService()
    ...
    def change_password(
        ...
        *,
        ...
        prefs = self.settings.get_or_create_settings(user)
